...
class InstrumentoForm(forms.ModelForm):
    """Formulário consolidado para Instrumento com suporte a M2M e Bootstrap"""
    class Meta:
        model = Instrumento
        fields = [
...
class ObrigacaoForm(forms.ModelForm):
    """Formulário consolidado para Obrigação inline"""
    class Meta:
        model = Obrigacao
        ...
        widgets = {
            ...
            'status': forms.Select(attrs={'class': 'form-select'}),
            'percentual_atendimento': forms.NumberInput(attrs={'class': 'form-control', 'min': '0', 'max': '100', 'placeholder': '0-100'}),
